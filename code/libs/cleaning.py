...
rid = ["las", "los", "se", "les", "he", "ha", "haber", "mi", "sus", "que", "el", "de", "su",
        "lo", " ", "la", "le", "e", "a", "y", "me", "en", "ya", "por", "si", "no", "con", "un",
...
def clean_text_round1(text):
    ...
    text = re.sub('[%s]' % re.escape(string.punctuation.replace("_","")+"¿"), ' ', text)#Original -> '[%s]' % re.escape(string.punctuation)
...
def clean_list(word):
    ...
    diccionario = {"tt":"cliente", "dev": "devolución", "aut":"autorización", "mov": "movimiento", "msj":"mensaje",
                   "zteca":"azteca", "atte":"atentamente", "cel":"celular", "cell":"celular", "col":"colonia", 
                   "eror":"error", "erro":"error", "fb":"facebook", "uds":"ustedes", "yono":"yo no", "qeu":"que",
                   "iso":"hizo", "th":"cliente", "x":"por", "oara":"para", "vee":"ver", "nk":"no", "sw":"", "nl":"no",
                   "spai":"spei", "pp":"app", "etsa":"esta", "poyo":"apoyo", "paea":"para", "ub":"un", "ze":"", 
                   "qe":"que", "yp":"yo", "np":"no", "q":"", "uma":"una","ttse":"cliente", "uba":"una", "upf":"ustedes",
                   "hivan":"iban", "tarbeta":"tarjeta", "ununia":"unos", "twbgo":"tengo", "ahy":"ahi", 
                   "aparecieon":"aparecieron", "ap":"app", "bca":"banca", "bco":"banco", "blq":"bloqueo", "aya":"haya",
                   "bnco":"banco", "bsnco":"banco", "c":"", "claracion":"aclaracion", "cn":"con", "ct":"cliente", 
                   "cta":"cliente", "cte":"cliente", "ctt":"cliente", "d":"", "eo":""}
...
def limpieza_total(serie, del_stopwords=[]):
    ...
    Aplica las funciones:
        ...
        2) correccion_lista
        3) lista_a_frase
    Las funciones son aplicadas en ese mismo orden
    
    Input:
        +Serie de Pandas con comentarios (string), en este caso no necesita pre
        procesarse
