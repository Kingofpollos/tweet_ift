...
def train_test_split_tweets(tweets,y=SENTIMENT, test_size = 0.2, random_state = 42):
    ...
    return train_test_split(tweets[CLEANED], 
                            tweets[y], 
                            test_size=test_size, 
                            random_state=random_state)

def train_vectorizer(X_train, min_samples = 10, save_vectorizer = True,PATH = '../../models/vec_entrenado.pkl'):
    """
...
def train_model(X_train, y_train, param_grid,model, cv = 5, save_model = True,PATH = '../../models/model_entrenado.pkl'):
    """
